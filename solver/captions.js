...
// form, width, height and padding (see `solve`). A candidate whose rectangle
// could differ is a candidate from a different entry.
function posBox(p) {
...
function solve(wants, board, opts) {
  ...
  // margin is the larger, per pair, so this cannot change an answer -- it can
